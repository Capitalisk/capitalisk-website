...
const features = [
  {
    ...
    description: (
      <>
        ...
        <p>
          In the long term, Capitalisk aims to create incentives for individuals and businesses to flexibly accept many different kinds of tokens as a form of payment for goods and services which they provide. The goal is to allow different tokens to be weighted automatically based on their relative values.
        </p>
        <p>
