...
const features = [
  {
    ...
    description: (
      <>
        ...
        <p>
          Capitalisk allows the relative value of any token in its ecosystem to be determined automatically and trustlessly thanks to permanent, decentralized on-chain records of trades generated by Decentralized Exchanges (DEXs).
        </p>
      </>
    ),
  },
