...
const features = [
  {
    ...
    description: (
      <>
        <p>
          Capitalisk (CLSK) is a cryptocurrency and a multi-blockchain ecosystem built on top of Lisk DEX (<a href="https://ldex.trading/" target="_blank">website</a>, <a href="https://github.com/Capitalisk/lisk-dex" target="_blank">GitHub</a>).
